  ...
  return (
    <div>
      <nav className="flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-10 items-center font-regular">
	...
	s-1.25-2.31-2.15-3.21s-1.97-1.61-3.21-2.15s-2.54-0.8-3.91-0.8H14.8V24.51z"
      ...
      <div className="flex items-center gap-2 mt-9">
        ...
        <div className="flex flex-row items-center">
          <p className="font-extralight text-[1rem]">Hello I'm</p>
        ...
        {/* <div className="main flex flex-col md:flex-row w-full gap-5 mb-9">
          ...
          >
            <p className="cursor-default font-regular text-[12px] md:text-base">
              {" "}
              Portfolio website ~{" "}
              <span className="text-gray-600">January 03, 2024</span>
            </p>
            <svg
              stroke="currentColor"
              fill="none"
      ...
      <section className="contact">
        <div className="contact">
          ...
          <div className="flex flex-col gap-7">
            <div className="name md:w-1/2 border border-gray-500 p-3 rounded-lg ">
              <input
            ...
            <div className="name md:w-1/2 border border-gray-500 p-3 rounded-lg  h-40 ">
              <textarea
            ...
            <div>
              <button className="text-white bg-black border rounded-md p-2 mb-5">
                Send Message
              </button>
            </div>
          </div>
